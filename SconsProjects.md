...
* [IoTivity](https://iotivity.org) - IoTivity is an open source software framework enabling seamless device-to-device connectivity to address the emerging needs of the Internet of Things ([SConstruct (mirror site)](https://github.com/iotivity/iotivity/blob/master/SConstruct))
* [LProf](http://lprof.sourceforge.net) - ICC Profile creation application for color managing your imaging devices ([SConstruct](http://lprof.cvs.sourceforge.net/viewvc/lprof/lprof/SConstruct?view=markup))
* [Lumiera](http://lumiera.org) - professional video editor for Linux ([SConstruct](http://git.lumiera.org/gitweb?p=LUMIERA;a=blob;f=SConstruct), [Setup.py](http://git.lumiera.org/gitweb?p=LUMIERA;a=blob;f=admin/scons/Setup.py),  [Platform.py](http://git.lumiera.org/gitweb?p=LUMIERA;a=blob;f=admin/scons/Platform.py), [a SConscript](http://git.lumiera.org/gitweb?p=LUMIERA;a=blob;f=src/SConscript)) 
...
* [XMIPP](https://github.com/I2PC/xmipp) Xmipp is a suite of image processing programs, primarily aimed at single-particle 3D electron microscopy, CNB, CSIC
