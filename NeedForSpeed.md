 ...
 * The code is doing work is has to, but slowly. This might include small language inefficiencies, too much recursion or otherwise deeply nested execution contexts, etc.  Certainly, running a scanner over all the dependencies in a project with thousands of files takes some time, and requires waiting for I/O. Profiling the code helps identify these areas.
