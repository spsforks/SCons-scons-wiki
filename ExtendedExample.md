...
```
then the projectx/SConscript doesn't have to know about the mode at all.  And your build dir can go wherever you like, just set up the variant_dir arg properly.  The SConscripts can just look like this: 
```python
foo = Project(...)
Alias('projectx', foo)
bar = OtherThing(...)
